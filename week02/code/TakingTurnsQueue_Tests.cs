...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: people were added to the front of the queue instead of the end.
    ...
    // Defect(s) Found: Queue order was reversed because enqueue was adding to the front when it should have added to the back.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: people with infinite turns weren't being added back into the queue after their turn.
    ...
    // Defect(s) Found: People with negative infinite turns were also not being added back to the queue after their turn.
