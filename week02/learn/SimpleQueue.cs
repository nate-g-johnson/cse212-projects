public class SimpleQueue
{
    public static void Run()
    {
        ...
        // Defect(s) Found: Was attempting to remove from index 1. should be removing from 0
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: was being queued at 0 instead of the end of the queue.
        ...
        // Defect(s) Found: Worked correctly.
    }
